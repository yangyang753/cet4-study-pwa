...
export function SubjectiveEditor({ question, kind, repository = defaultRepository }: { question: SubjectiveQuestion; kind: 'writing' | 'translation'; repository?: LearningRepository }) {
