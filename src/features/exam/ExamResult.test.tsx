...
describe('ExamResult', () => {
  it('shows a clearly labeled preparation estimate and subjective self-check', () => {
    ...
    const repository = { upsertReviewCard: vi.fn().mockResolvedValue(undefined), listSubmittedExamSessions: vi.fn().mockResolvedValue([session]) } as unknown as LearningRepository;
